...
{
    $conn = db_conn();
    $selectQuery = "INSERT into patient_info (C_Name, C_Email, C_PhoneNumber, C_Password, C_Gender, C_DOB, C_ProfilePicture, C_PresentAddress) VALUES (:name, :email, :phoneNo, :password, :gender, :dateOfBirth, :profilePic, :presentAddress)";
    try {
        ...
        $stmt->execute([
            ...
            ':presentAddress'   =>      test_input($data['presentAddress']),
...
{
    $conn = db_conn();
    $selectQuery = "UPDATE patient_info set C_Name = ?, C_PhoneNumber = ?, C_Gender = ?, C_DOB = ? where C_Email = ?";
    try {
        $stmt = $conn->prepare($selectQuery);
        $stmt->execute([
...
{
    $conn = db_conn();
    $selectQuery = "UPDATE patient_info set C_Password = ? where C_Email = ?";
    try {
        $stmt = $conn->prepare($selectQuery);
        $stmt->execute([
